...
#update the numbers of the table below.
...
```
 ...
 The graph above is the sensitivity chart for laptop design with 8GB RAM, 256GB  memory, i5 processor, 13 inch screen size at 1K price range which weigh about 1kg. We can see that, reducing the RAM to 8GB would increase the share by almost 0.23 and increasing the memory from 512GB to 1TB would also increase the preference shares by 0.33. Any change in screen size or weight will have a negative effect on the preference shares. 
...
Main attribute: memory, biggest change was towards 1T. 
Memory is homogeneous, we can make the change safely. 

Analyse if is worth changing weight (towards 1.5) and processor ( towards i5)
