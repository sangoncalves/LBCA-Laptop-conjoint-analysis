...
```{r predict bootstrap - Fixed model, eval=FALSE, include=FALSE}
...
We need to compare the two new models (lm2.mixed) with the previously chosen one (Fixed effect, no intercept) in order to choose which one to use. Same steps as the first choice of model.
